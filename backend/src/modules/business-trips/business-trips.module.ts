...
@Module({ imports: [AuthModule, TypeOrmModule.forFeature([BusinessTripEntity, BusinessTripMemberEntity, CustomerEntity])], controllers: [BusinessTripsController], providers: [BusinessTripsService] })
